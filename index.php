...
// No Cross-Origin-Embedder-Policy because iframe be need to display content that has not opted in.
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="column">
                <h2>Rendered page <button id="popupButton" onclick="popup()" disabled>Separate window</button></h2>
